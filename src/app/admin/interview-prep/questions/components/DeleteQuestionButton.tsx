...
import { deleteQuestion } from '@/app/admin/interview-prep/questions/actions';
    ...
    <>
      {showConfirm && (
        <DeleteConfirmDialog
          ...
          description="Deleting a question also removes its saved progress across sessions."
          itemName={questionLabel}
