...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    // Paragraphs and text
    p: ({ children, ...props }) => (
      <p className="my-4 leading-7 text-gray-700 dark:text-gray-200" {...props}>
        {children}
      </p>
    ),
    ...
    ul: ({ children, ...props }) => (
      <ul
        className="my-4 ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-200"
        {...props}
      >
        {children}
      </ul>
    ...
    ol: ({ children, ...props }) => (
      <ol
        className="my-4 ml-6 list-decimal space-y-2 text-gray-700 dark:text-gray-200"
        {...props}
      >
        {children}
      </ol>
    ...
    blockquote: ({ children, ...props }) => (
      <blockquote
        className="my-6 border-l-4 border-mocha-300 pl-4 italic text-gray-700 dark:border-mocha-600 dark:text-gray-200"
        {...props}
      >
        {children}
      </blockquote>
