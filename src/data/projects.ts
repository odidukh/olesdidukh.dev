...
export const projectsData: Project[] = [
  {
    ...
    image:
      'https://via.placeholder.com/800x600/A47864/ffffff?text=Safebooks+AI',
    images: [
      'https://via.placeholder.com/800x600/A47864/ffffff?text=Dashboard',
      'https://via.placeholder.com/800x600/A47864/ffffff?text=Analytics',
      'https://via.placeholder.com/800x600/A47864/ffffff?text=Reports',
    ],
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/800x600/10b981/ffffff?text=E-Commerce',
    images: [
      'https://via.placeholder.com/800x600/10b981/ffffff?text=Product+Catalog',
      'https://via.placeholder.com/800x600/10b981/ffffff?text=Checkout',
      'https://via.placeholder.com/800x600/10b981/ffffff?text=Admin+Panel',
    ],
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/800x600/3b82f6/ffffff?text=Healthcare',
    images: [
      'https://via.placeholder.com/800x600/3b82f6/ffffff?text=Patient+Dashboard',
      'https://via.placeholder.com/800x600/3b82f6/ffffff?text=Video+Consultation',
      'https://via.placeholder.com/800x600/3b82f6/ffffff?text=Appointments',
    ],
    featured: true,
    year: 2023,
    duration: '10 months',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/800x600/f59e0b/ffffff?text=FinTech',
    images: [
      'https://via.placeholder.com/800x600/f59e0b/ffffff?text=Analytics',
      'https://via.placeholder.com/800x600/f59e0b/ffffff?text=Charts',
      'https://via.placeholder.com/800x600/f59e0b/ffffff?text=Reports',
    ],
  ...
  },
  {
    ...
    image:
      'https://via.placeholder.com/800x600/8b5cf6/ffffff?text=Social+Learning',
    images: [
      'https://via.placeholder.com/800x600/8b5cf6/ffffff?text=Feed',
      'https://via.placeholder.com/800x600/8b5cf6/ffffff?text=Classroom',
      'https://via.placeholder.com/800x600/8b5cf6/ffffff?text=Resources',
    ],
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/800x600/ef4444/ffffff?text=Fitness+App',
    images: [
      'https://via.placeholder.com/800x600/ef4444/ffffff?text=Workouts',
      'https://via.placeholder.com/800x600/ef4444/ffffff?text=Progress',
      'https://via.placeholder.com/800x600/ef4444/ffffff?text=Nutrition',
    ],
    featured: false,
    year: 2021,
    duration: '3 months',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/800x600/22c55e/ffffff?text=CMS',
    images: [
      'https://via.placeholder.com/800x600/22c55e/ffffff?text=Editor',
      'https://via.placeholder.com/800x600/22c55e/ffffff?text=API',
      'https://via.placeholder.com/800x600/22c55e/ffffff?text=Analytics',
    ],
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/800x600/a855f7/ffffff?text=UI+Library',
    images: [
      'https://via.placeholder.com/800x600/a855f7/ffffff?text=Components',
      'https://via.placeholder.com/800x600/a855f7/ffffff?text=Storybook',
      'https://via.placeholder.com/800x600/a855f7/ffffff?text=Documentation',
    ],
