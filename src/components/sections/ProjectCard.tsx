...
export function ProjectCard({
  ...
  return (
    ...
    >
      <Card
        className="overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full flex flex-col group"
        onClick={onClick}
      >
        {/* Image */}
        <div className="relative h-48 bg-muted overflow-hidden">
          ...
          {/* Featured Badge */}
          {project.featured && (
            <div className="absolute top-3 right-3 bg-yellow-500 text-yellow-900 rounded-full p-1.5 shadow-lg">
              <Star className="h-3 w-3 fill-current" />
            </div>
          )}
